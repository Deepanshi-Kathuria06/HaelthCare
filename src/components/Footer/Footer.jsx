      ...
      <div className="footer-container">
        ...
        <div className="footer-content">
          <div className="footer-brand">
            <div className="footer-logo">
              {/* <img src={HeartIcon} alt="HeartShield Logo" className="logo-icon" /> */}
              <span className="logo-text">HeartShield</span>
            </div>
            <p className="footer-tagline">
              Protecting hearts at work through advanced cardiac screening and prevention.
            </p>
          </div>
        ...
        <div className="footer-bottom">
          <div className="copyright">
            © 2025 HeartShield. All rights reserved.
          </div>
          
          <div className="social-links">
            <a href="https://linkedin.com" aria-label="LinkedIn" className="social-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#5a67d8">
